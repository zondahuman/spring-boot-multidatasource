package com.abin.lee.spring.boot.multids.common.generator;
...
public class SnowflakeIdWorker {
    private static final Integer sequenceGene = 2;
    ...
    public synchronized long nextId(Long geneEnd) {
        ...
        long gene = Longs.tryParse(getByte(Long.toBinaryString(geneEnd)));
